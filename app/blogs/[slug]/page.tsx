  ...
  return (
    <div className="relative min-h-screen w-3/4 md:w-full mx-auto">
      <div className="relative z-[1]">
        ...
        <main className="relative z-10 dark:text-secondary-main grid grid-cols-[1fr,min(640px,100%),1fr] gap-y-8 px-4 pb-12 text-lg text-primary-main xl:grid-cols-[1fr,minmax(auto,240px),min(640px,100%),minmax(auto,240px),1fr] xl:gap-x-9 xl:px-0 [&>*]:col-start-2 xl:[&>*]:col-start-3">
          <div className="sticky top-6 hidden h-0 xl:!col-start-4 xl:row-start-2 xl:block">
            <div className="space-y-6">
              {blog.headings ? (
                <div className="space-y-2 text-sm">
                  <div className="uppercase text-primary-main dark:text-secondary-main font-bold">
                    On this page
                  </div>
